...
# Función de costos
La función que indica el gasto mínimo necesario para producir una cierta cantidad $q$ de producto, dada por los insumos se llama **función de costos**. Se denota con $C(q)$ y tiene la forma:
![[Pasted image 20251215172911.png]]
...
![[Pasted image 20251215173055.png]]
en donde se grafica la relación inversa: La curva de oferta inversa, $q_{s}^{-1}(P)$

# 
El objetivo de una firma es maximizar la **utilidad**, esto es la diferencia entre ***Ingresos y los Costos de producción***.
...
$$
Es una situación en donde la firma considera el precio $P$ como un dato, osea no se cree que se puede modificar el precio de venta por sí mismo.
...
$$
donde 
* $C F$ no depende de la cantidad $q$ de producción.
  *Ejemplo: El arriendo de un espacio, el sueldo de trabajadores.*

* $C V(q)$ depende de la cantidad de producción $q$ 
...
En economía, a la primera derivada de una función se le denomina la **condición de primer grado (CPO)**, en donde se hace:
$$
\Pi'(P) =0
$$
en donde la cantidad de producción óptima $Q^{*}$ es donde el precio de venta es igual a la utilidad: $P = \Pi'$ 

La primera derivada de la función de costo corresponde al **costo marginal**, esto es, cuánto varía el costo al aumentar en una unidad la cantidad producida $Q$.
![[Pasted image 20251215173846.png]]
...
![[Pasted image 20251215173950.png]]
